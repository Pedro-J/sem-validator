    ...
    <div class="container">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <form:form class="form-horizontal" method="post" modelAttribute="question" action="${formActionUrl}">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <c:choose>
                                <c:when test="${question['new']}">
                                    <button type="submit" class="btn-lg btn-primary pull-right"><s:message code="general.save" /> </button>
                                </c:when>
                                <c:otherwise>
                                    <button type="submit" class="btn-lg btn-primary pull-right"><s:message code="general.update" /> </button>
                                </c:otherwise>
                            </c:choose>
                        </div>
                    </div>
