                        ...
                        <div class="form-group ${status.error ? 'has-error' : ''}">
                            ...
                            <div class="col-sm-5">
                                <form:select path="checkList.id" class="form-control">
                                    ...
                                    <form:options items="${criterions}" itemValue="checkList.id"
                                                  itemLabel="checkList.title"/>
                                </form:select>
                        ...
                        <div class="col-sm-offset-2 col-sm-10">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    ...
                                    <a href="/requirements/list" class="btn btn-default pull-right"><s:message code="general.back" /> </a>
